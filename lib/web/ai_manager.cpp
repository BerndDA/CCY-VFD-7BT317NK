...
void AiManager::process() {
    ...
    switch (_state) {
        case State::CREATE_THREAD: {
            ...
            idFilter["id"] = true;
            deserializeJson(doc, _http->getStream(), DeserializationOption::Filter(idFilter));
            _threadId = doc["id"].as<String>();
        ...
        case State::POLL_RUN: {
            ...
            deserializeJson(doc, _http->getStream(), DeserializationOption::Filter(statusFilter));
            _http->end();
        ...
        case State::GET_MESSAGES: {
            ...
            deserializeJson(doc, _http->getStream(), DeserializationOption::Filter(msgFilter));
            _http->end();
