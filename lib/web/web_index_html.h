              ...
              <el-main>
                  ...
                  <el-card class="box-card">
                      <el-form ref="form" :model="form" label-width="100px" label-position="top">
                          ...
                          <el-form-item label="RGB Lighting Effect">
                              <el-switch v-model="form.rgbOpen"></el-switch>
                          </el-form-item>
                          <el-form-item label="RGB Lighting Style" v-if="form.rgbOpen">
                              <el-radio-group v-model="form.rgbStyle">
                                  <el-radio :label="1">Gradient Breathing</el-radio>
                                  <el-radio :label="2">Rainbow Gradient</el-radio>
                                  <el-radio :label="3">Horror Gloom</el-radio>
                              </el-radio-group>
                          </el-form-item>
                          <el-form-item label="RGB Brightness" v-if="form.rgbOpen">
                              <el-slider :show-tooltip="false" v-model="form.rgbBrightness" :min="15" :max="255"></el-slider>
                              <el-tag effect="dark" type="primary">Brightness Percentage: {{Math.floor(form.rgbBrightness/255*100)}}%</el-tag>
                          </el-form-item>
                          ...
                          <el-form-item label="OTA Firmware Upgrade">
                              <el-link href="/update" type="primary">Go to Upgrade Page</el-link>
                              <p>Operation Tutorial:
                                  <el-link target="_blank" href="http://www.saisaiwa.com/archives/vfd-clock-userdescription" type="info">User Manual</el-link>
                              </p>
                          </el-form-item>
